...
const PrivacyPolicy = () => (
  <div style={container}>
    ...
    <h2 style={header}>Privacy Policy</h2>{" "}
    <p>
      Meka Labs built the Bit Bash app as an Ad Supported app. This SERVICE is
      provided by Meka Labs at no cost and is intended for use as is.
    </p>{" "}
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Bit Bash unless otherwise
      defined in this Privacy Policy.
    </p>{" "}
    <h3 style={header}>Information Collection and Use</h3>{" "}
    <p>
    ...
    <h3 style={header}>Service Providers</h3>{" "}
    <p>
    ...
    <h3 style={header}>Links to Other Sites</h3>{" "}
    <p>
    ...
    <h3 style={header}>Children’s Privacy</h3>{" "}
    <p>
    ...
    <h3 style={header}>Changes to This Privacy Policy</h3>{" "}
    <p>
    ...
    <h3 style={header}>Contact Us</h3>{" "}
    <p>
      If you have any questions or suggestions about our Privacy Policy, do not
      hesitate to contact us at info@bitbash.app.
    </p>{" "}
    <p>
